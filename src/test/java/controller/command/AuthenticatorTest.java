...
class AuthenticatorTest {
    ...
    void authenticateTestTrue() {
        Credential credential = new Credential(new LibraryNumber("123-4567"),new Password("password1"),null);
    ...
    void authenticateTestFalse() {
        Credential credential = new Credential(new LibraryNumber("123-4567"),new Password("password2"),null);
